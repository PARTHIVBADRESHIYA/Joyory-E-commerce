...
//             if (catDoc?._id) {
//                 trackedCategoryId = catDoc._id; // 👈 for browsing history tracking
...
//         // ✅ Track product + category in browsing history
//         if (req.user) {
//             await User.findByIdAndUpdate(req.user.id, {
//                 $push: {
//                     recentProducts: { $each: [product._id], $position: 0, $slice: 20 },
//                     recentCategories: { $each: [product.category], $position: 0, $slice: 20 }
//                 }
//             });
//         }
...
//         // ✅ Category details (minimal info for frontend)
//         let categoryObj = null;
//         if (mongoose.Types.ObjectId.isValid(product.category)) {
//             categoryObj = await Category.findById(product.category)
//                 .select('name slug')
...
/**
 * GET /products/category/:slug (track category browsing)
 */
...
//         // ✅ Track category in browsing history
//         if (req.user) {
//             await User.findByIdAndUpdate(req.user.id, {
//                 $push: {
