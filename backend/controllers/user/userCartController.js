...
//               hex: variant.hex,
//               image: variant.images?.length ? variant.images : product.images?.length ? product.images : []
//             };
//           } else {
//             continue;
//           }
...
//           images: variant.images?.length ? variant.images : product.images?.length ? product.images : [],
...
//         // Calculate prices but keep the original image
//         const calcVariant = calculateVariantPrices([item.selectedVariant], productDoc, activePromotions)[0];
//         enrichedVariant = {
//           ...calcVariant,
//           images: item.selectedVariant.image ? [item.selectedVariant.image] : calcVariant.images || [],
//         };
//       } else {
...
//         giftCardDiscount = maxRedeemable;
//         giftCardApplied = { status: "Applied", code: giftCard.code, appliedAmount: giftCardDiscount, remainingBalance: giftCard.balance - giftCardDiscount, message: `🎉 Successfully applied ₹${giftCardDiscount} from your gift card!` };
//       }
//     }
...
//         enrichedVariant = {
//           ...calcVariant,
//           images: item.selectedVariant.images?.length ? item.selectedVariant.images : calcVariant.images || productDoc.images || [],
//         };
//       } else {
//         enrichedVariant = calculateVariantPrices([getPseudoVariant(productDoc)], productDoc, activePromotions)[0];
