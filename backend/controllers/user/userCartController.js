...
//           sku: variantFromProduct?.sku || null
//         };
//       } else {
//         const calcVariant = calculateVariantPrices([getPseudoVariant(productDoc)], productDoc, activePromotions)[0];
//         enrichedVariant = {
//           ...calcVariant,
//           images: calcVariant.images || productDoc.images || [],
//           shadeName: calcVariant?.shadeName || productDoc.variant || null,
//           hex: calcVariant?.hex || null,
//           sku: calcVariant?.sku || null
//         };
//       }
