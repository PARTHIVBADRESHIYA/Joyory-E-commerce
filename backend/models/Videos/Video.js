...
//                     return /^https?:\/\/.+/.test(v); // check only format
//                 },
//                 message: 'Invalid URL',
//             },
//         },
...
// // Extract YouTube video ID (supports watch?v=, youtu.be, shorts)
// function extractYouTubeId(url) {
//     if (!url) return null;

//     const regexList = [
//         /(?:youtube\.com\/.*v=|youtu\.be\/)([^&#?/]+)/, // watch?v= or youtu.be
...
//         }
//         this.providerId = videoId; // store normalized ID
//     }
...
//         }
//         // You can extract Vimeo ID if needed
//     }
