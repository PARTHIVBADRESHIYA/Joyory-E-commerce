...
import { filterPaymentsByDate, getDashboardSummary, getPaymentsFiltered, payForOrder, createWalletPayment,getOrderSuccessDetails,createGiftCardPayment, setRefundMethod, setPaymentMethod, getActivePaymentMethods, createCodOrder, confirmCodOrder, createRazorpayOrder, verifyRazorpayPayment } from '../../../controllers/settings/payments/paymentController.js';
...
router.get('/success/:orderId', authenticateUser, getOrderSuccessDetails);  
