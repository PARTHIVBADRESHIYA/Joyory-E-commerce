...
// // /**
// //  * One-time migration:
// //  * Add required skinTypes to ALL products
// //  */
...
// //                 // ✅ SALES INCREMENT (NO STOCK TOUCH)
// //                 variant.sales += item.quantity;

// //                 await product.save({ session });
// //             }

// //             // ✅ MARK ORDER AS ACCOUNTED
// //             order.salesAccounted = true;
// //             await order.save({ session });
// //         }
// //     });

// //     console.log("✅ OLD ORDER SALES BACKFILL COMPLETE");
...
//         // 🔐 extra safety: check if wallet already exists
...
//     console.log("🎉 Migration completed");
//     console.log({ processed, created, skipped });
...
export default function () {
    const res = http.get('https://joyory.com/');
